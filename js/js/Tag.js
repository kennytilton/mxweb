...
class Tag extends Model {
	constructor(parent, name, islots={}) {
        ...
        this.tag = islots.tag;
        this.slotObservers = [];
		if (this.content===42) this.content = null;
		//this.deleted = null;
...
function tag( tag, islots, kids=null) {
...
function div(islots, ...vargs) {
	return tag('div', islots, vargs);
}
function header(islots, ...vargs) {
	return tag('header', islots,  vargs);
}
function footer(islots, ...vargs) {
	return tag('footer', islots, vargs);
}
function h1(content, islots={}, ...vargs) {
	return tag('h1', Object.assign( {content: content}, islots), vargs);
}
function h2(content, islots={}, ...vargs) {
	return tag('h2', Object.assign( {content: content}, islots), vargs);
}
function h3(content, islots={}, ...vargs) {
	return tag('h3', Object.assign( {content: content}, islots), vargs);
}
function h4(content, islots={}, ...vargs) {
	return tag('h4', Object.assign( {content: content}, islots), vargs);
}
function h5(content, islots={}, ...vargs) {
	return tag('h5', Object.assign( {content: content}, islots), vargs);
}
function h6(content, islots={}, ...vargs) {
	return tag('h6', Object.assign( {content: content}, islots), vargs);
}
function section(islots, ...vargs) {
	return tag('section', islots, vargs);
}

function ul(islots, ...vargs) {
	return tag('ul', islots, vargs);
}

function li(islots, ...vargs) {
	return tag('li', islots, vargs); //cdrArgs(arguments));
}
// todo Standardize all these so islots precedes content
function label(content, islots, ...varargs) { // can a label have kids?
	return tag('label', Object.assign( {content: content}, islots), varargs);
}
function labelx(islots, ...vargs) { // todo can a label have kids?
	ast( islots.content, 'labelx sees islots sans content');
	return tag('label', islots, vargs);
}
function button(content, islots, ...vargs) {
	return tag('button', Object.assign( {content: content}, islots), vargs);
}
...
function a(islots, content=null) {
...
class MXStorable extends Model {
    ...
    constructor( icslots) {
        ...
        if (this.deleted ==="booya")
            this.deleted = null; //gcfight
...
/*    static make( klass, islots ) {
    ...
    toJSON () {
        // todo come up with generic solution that survives google closure compilation
        return {}; // override in subclass to get slots stored
    }
